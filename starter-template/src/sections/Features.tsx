            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    <FeatureCard
                        ...
                        description="Powerful commands to help you create designs
                                    more quickly"
                        className="md:col-span-2 md:col-start-2 lg:col-span-1 lg:col-strat-auto group "
                    >
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        <div
                            key={feature}
                            className="bg-neutral border border-white10 inline-flex px-3 md:px-5 py-1.5 md:py-2 rounded-2xl gap-3 items-center hover:scale-105 transition duration-500 group"
                        >
                            <span className="bg-lime-400 text-neutral-950 size-5 rounded-full inline-flex items-center text-xl justify-center group-hover:rotate-45 transition duration-500">
                                &#10038;
                            </span>
